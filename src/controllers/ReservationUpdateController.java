    ...
    private void simpanClicked(ActionEvent event){
       if(nbTable.getText().equals("")||nbPerson.getText().equals("")||dateReservation_text.getText().equals("")){
           ...
           java.sql.Date date = java.sql.Date.valueOf(dateReservation.getValue());
            Reservation reser = new Reservation(Integer.parseInt(idText),Integer.parseInt(nbTable_text), Integer.parseInt(nbTable_text),date);
           model.update(idText, nbTable_text, nbPerson_text, date_text);
